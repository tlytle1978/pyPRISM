...
class Exponential(Potential):
    ...
    **Mathematical Definition**
    ...
    .. math::
        ...
        U_{\alpha,\beta}(r \geq \sigma_{\alpha,\beta}) =
        \epsilon_{\alpha,\beta} \exp\left( - \frac{r-\sigma_{\alpha,\beta}}{\alpha}\right)
    ...
    **Description**
    ...
    .. code-block:: python
        ...
        sys.potential['A', 'B'] = pyPRISM.potential.Exponential(epsilon=1.0,
                                                               sigma=8.0,
                                                               alpha=0.5,
                                                               high_value=10**6)
